...
class PageService implements PageUseCase {
    private final LoadPageInfoCommand loadPageInfoCommand;

    public PageService(final LoadPageInfoCommand loadPageInfoCommand) {
    ...
    protected List<SummaryPageInfo> loadBreadcrumbs(final String pageId) {
